...
data_path = r"Documents\data\Methods-Paper_EMG\anesthetized_baseline.smrx"
...
tsx_emg_r = data_block.analogsignals[3]
...
axs[0].set_title(
    "Anesthetized eupnic breathing bilateral diaphragm EMG recording",
    fontsize=16,
    fontweight="bold",
)
...
plt.show()
# %%
fig.savefig("figs/anesthetized_eupnic_original_left-right.png", dpi=600)
